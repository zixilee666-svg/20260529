...
- Name: 03-dashboard.spec.ts >> Dashboard Page >> should load and display statistics cards
- Location: e2e\03-dashboard.spec.ts:7:3
...
Call log:
  ...
  - waiting for getByText('文献总量').first()
