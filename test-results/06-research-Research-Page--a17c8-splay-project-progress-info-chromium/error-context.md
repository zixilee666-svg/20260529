...
- Name: 06-research.spec.ts >> Research Page >> should display project progress info
- Location: e2e\06-research.spec.ts:13:3
...
Call log:
  ...
  - waiting for getByText('HGNN').first()
