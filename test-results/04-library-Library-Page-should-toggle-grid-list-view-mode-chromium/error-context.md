...
- Name: 04-library.spec.ts >> Library Page >> should toggle grid/list view mode
- Location: e2e\04-library.spec.ts:42:3
...
Locator: getByText('Semi-Supervised Classification').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Semi-Supervised Classification').first()
    ...
    - main [ref=e80]:
      - generic [ref=e83]:
        ...
        - generic [ref=e93]:
          - generic [ref=e94]:
            - img [ref=e95]
            - textbox "搜索标题、作者、关键词、会议..." [ref=e98]
          - button "筛选" [ref=e99] [cursor=pointer]:
            - img
            - text: 筛选
            - img
        - generic [ref=e100]:
          - img [ref=e102]
          - heading "没有找到匹配的文献" [level=3] [ref=e104]
          - paragraph [ref=e105]: 当前筛选条件下没有文献，请调整筛选条件。
      - generic [ref=e108]:
        - paragraph [ref=e109]:
          - generic [ref=e110]: © 2026 Academic Hub. All rights reserved.
        - generic [ref=e111]:
          - link "粤ICP备2026052655号-1" [ref=e112] [cursor=pointer]:
            - /url: https://beian.miit.gov.cn/
          - generic [ref=e113]: "|"
          - link "公安备案" [ref=e114] [cursor=pointer]:
