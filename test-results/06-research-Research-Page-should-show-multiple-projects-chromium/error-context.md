...
- Name: 06-research.spec.ts >> Research Page >> should show multiple projects
- Location: e2e\06-research.spec.ts:20:3
...
Locator: getByText('HGNN 金融欺诈检测综述')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('HGNN 金融欺诈检测综述')
